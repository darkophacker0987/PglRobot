...
from CYBERKING.modules.helper_funcs.string_handling import split_quotes
from CYBERKING.modules.log_channel import loggable
from CYBERKING.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # CYBERKING's sticker
        keyboard = None
        log_reason = (
