...
from CYBERKING import ALLOW_EXCL, CustomCommandHandler, dispatcher
...
from CYBERKING.modules.sql import cleaner_sql as sql
 ...
 *Following are Disasters only commands, admins cannot use these:*
 • `/gignoreblue <word>`*:* globally ignorea bluetext cleaning of saved word across CYBERKING.
